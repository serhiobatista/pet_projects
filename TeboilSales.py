...
rus_month = {1:'января', 2: 'февраля', 3:'марта', 
             4:'апреля', 5:'мая', 6:'июня',
            7:'августа', 8:'июля', 9:'сентября',
             10:'октября',11:'ноября', 12:'декабря'} # это словарь, который понадобится для
                                                     # заполнения шапки с датами по отчетному периоду
